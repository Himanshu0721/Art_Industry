    ...
    <footer className="bg-gray-100 py-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-blue-900 mb-4">Art Research</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://ten-artist.vercel.app" className="text-gray-600 hover:text-blue-900">Ten Art Research</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-600">© 2025 Art Research. All rights reserved.</p>
        </div>
      </div>
